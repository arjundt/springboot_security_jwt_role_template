...
public class ConfigParaKey{
	...
	public static String FILE_SIGNATURE_JPEG = "file_signature_jpeg";
	
	public static String FILE_SIGNATURE_PDF = "file_signature_pdf";
	
	public static String SP_EMAIL_VERIFICATION_DURATION = "sp_email_verification_duration";
	
	public static String SP_PORTAL_URL = "sp_portal_url";
	
	public static String SMTP_SP_VERIFICATION_EMAIL_CODE_URL = "smtp_sp_verificationemailcodeURL";
	
	public static String SMTP_SP_SERVICE_VERIFICATIONEMAILCODE_URL= "smtp_sp_service_cpemailverfyconfirmURL";
	
	public static String SPEMAIL_CODE_RESEND_COUNT = "sp_email_code_resend_count";

	public static String USER_MIGRATION_URL = "user_migration_url";
	
	public static String USER_MIGRATION_FOLDER_PATH = "user_migration_folder_path";
}
